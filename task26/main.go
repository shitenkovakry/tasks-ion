...
func AddNumbersToArray(array []int, num int) []int {
	...
	arrayWithSeparatedNumbers := SeparateDigits(num)

	for _, value := range arrayWithSeparatedNumbers {
		isSeparatedValueInArrayWithAddedNumbers := HasValueInArray(arrayWithAddedNumbers, value)

		if !isSeparatedValueInArrayWithAddedNumbers {
